...
load('./dataset/channel_dataset_Nt_16_B_5_T_3_K_4_num_50000.mat');
...
le = legend('MRT-PC','ZF-PC','WMMSE-PC','SCA-FP-Maxmin','SCA-FP','SCA-FP-CF'); set(le,'linewidth',1,'fontsize',16,'fontname','宋体');
grid on;
