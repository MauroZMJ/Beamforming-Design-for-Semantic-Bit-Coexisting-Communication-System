       ...
       %% Problem solve
        for i = 1:data_number
            ...
            for K = 1:length(K_list)
                ...
                %% SCA FP  
                if qos(1) >= beta_diff
                    [precoding_matrix,object_performance_list,cvx_obj_list,solving_result] = SCA_FP_v4(channel_instance,precoding_matrix_init,B,T,L,J,M,a,b,c,alpha,qos-beta_diff,sigma);
                else
